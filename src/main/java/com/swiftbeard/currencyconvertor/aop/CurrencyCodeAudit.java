package com.swiftbeard.currencyconvertor.aop;
...
public class CurrencyCodeAudit {
    ...
    @Pointcut("execution(* com.swiftbeard.currencyconvertor.service.*Service.*(.., @com.swiftbeard.currencyconvertor.annotation.ToUpper (*),..))")
